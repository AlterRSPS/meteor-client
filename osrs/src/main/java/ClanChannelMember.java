...
public class ClanChannelMember {
	...
	public static class512[] FillMode_values() {
		return new class512[]{class512.field4137, class512.field4136, class512.field4134};
	}
		...
		if (var0.cs1Instructions != null && var1 < var0.cs1Instructions.length) {
			try {
				...
				while (true) {
					...
					if (var6 == 18) {
						var7 = (Projectile.localPlayer.field_27 >> 7) + class213.baseX;
					}

					if (var6 == 19) {
						var7 = (Projectile.localPlayer.field_28 >> 7) + class101.baseY;
					}
	...
	static final void method759(int var0) {
		var0 = Math.min(Math.max(var0, 0), 127);
		class10.clientPreferences.setCurrentSoundEffectVolume(var0);
	}
}
