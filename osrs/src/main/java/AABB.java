...
public class AABB {
	...
	static final int method1283(int var0, int var1, int var2, int var3) {
	...
	static final void method1284(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, CollisionMap[] var10) {
		int var12;
			...
			for (int var13 = 0; var13 < 64; ++var13) {
				for (int var14 = 0; var14 < 64; ++var14) {
					if (var12 == var4 && var13 >= var5 && var13 < var5 + 8 && var14 >= var6 && var14 < var6 + 8) {
						int var15 = var2 + ModeWhere.method1955(var13 & 7, var14 & 7, var7);
						int var18 = var13 & 7;
						int var19 = var14 & 7;
						int var20 = var7 & 3;
						int var17;
	...
	static final void drawLoadingMessage(String var0, boolean var1) {
		if (Client.showLoadingMessages) {
			...
			class20.method69(var3 - var2, var4 - var2, var2 + var5 + var2, var6 + var2 + var2);
			if (var1) {
				WorldMapSectionType.rasterProvider.drawFull(0, 0);
			} else {
				class330.method1854(var3, var4, var5, var6);
			}
