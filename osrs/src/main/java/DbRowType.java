...
public class DbRowType extends DualNode {
	...
	public static AbstractArchive field4054;
	@ObfuscatedName("an")
	@ObfuscatedSignature(
		descriptor = "Llf;"
	)
	...
	void method2465(Buffer var1, int var2) {
		if (var2 == 3) {
			int var3 = var1.readUnsignedByte();
			if (this.columnTypes == null) {
				this.columnTypes = new Object[var3][];
				this.field4056 = new int[var3][];
			}
			...
			for (int var4 = var1.readUnsignedByte(); var4 != 255; var4 = var1.readUnsignedByte()) {
				...
				this.columnTypes[var4] = class154.method809(var1, var6);
				this.field4056[var4] = var6;
			}
		} else if (var2 == 4) {
			this.tableId = var1.method2520();
		}
