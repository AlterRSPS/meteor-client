...
public abstract class AbstractFont extends Rasterizer2D {
			...
			for (var13 = 0; var13 < 256; ++var13) {
				if (var13 != 32 && var13 != 160) {
					for (var8 = 0; var8 < 256; ++var8) {
						if (var8 != 32 && var8 != 160) {
							this.kerning[var8 + (var13 << 8)] = (byte)method2062(var11, var12, var4, this.advances, var10, var13, var8);
						}
					}
				}
			}
						...
						if (var7.equals("lt")) {
							...
							if (!var7.equals("gt")) {
								if (var7.startsWith("img=")) {
									try {
										int var8 = TextureProvider.method1301(var7.substring(4));
				...
				if (var15 == '<') {
					...
					if (var15 == '>' && var10 != -1) {
						...
						if (var16.equals("br")) {
							...
							try {
								int var17 = TextureProvider.method1301(var16.substring(4));
	...
	public Bounds method2069(int var1, int var2, String var3, int var4, int var5) {
	...
	public int drawLines(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		return this.method2075(var1, var2, var3, var4, var5, var6, var7, 256, var8, var9, var10);
	}

	@ObfuscatedName("am")
	public int method2075(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
		if (var1 == null) {
			return 0;
		} else {
			if (var8 == 255) {
	...
	public class473 method2076(class396 var1, int var2, int var3, int var4, int var5, int var6) {
		if (!var1.method2098()) {
			this.reset(var4, var5);
			var3 -= this.ascent;

			for (int var7 = 0; var7 < var1.method2099(); ++var7) {
				class394 var8 = var1.method2103(var7);
				if (var6 != -1 && var8.field3637 * -493099907 > var6) {
					return new class473(var8.field3636, var8.field3637 * -493099907);
				}

				char var9 = var8.field3635;
				if (var9 != '\n') {
					if (var1.method2096(var7)) {
						var9 = '*';
					}
					...
					if (var9 != '\t') {
						...
						int var10 = var2 + var8.field3636;
						int var11 = var3 + var8.field3637 * -493099907;
		...
		return var1.method2102();
	}

	@ObfuscatedName("bc")
	public void method2077(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var8 = null;
			if (var7 != null) {
				var8 = this.method2082(var7, var1.length());
			}
			...
			this.method2088(var1, var2 - this.stringWidth(var1) / 2, var3, var8, (int[])null, var9);
		}
	}

	@ObfuscatedName("bj")
	public void method2078(String var1, int var2, int var3, int var4, int var5, int var6, int[] var7) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var8 = null;
			if (var7 != null) {
			...
			this.method2088(var1, var2 - this.stringWidth(var1) / 2, var3, var8, var9, var10);
		}
	}

	@ObfuscatedName("bo")
	public void method2079(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int[] var8) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var9 = null;
			if (var8 != null) {
				var9 = this.method2082(var8, var1.length());
			}
			...
			this.method2088(var1, var2 - this.stringWidth(var1) / 2, var3, var9, (int[])null, var12);
		}
	}

	@ObfuscatedName("bq")
	public void method2080(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var7 = null;
			if (var6 != null) {
				var7 = this.method2082(var6, var1.length());
			}

			this.method2088(var1, var2 - this.stringWidth(var1) / 2, var3, var7, (int[])null, (int[])null);
		}
	}

	@ObfuscatedName("bg")
	public void method2081(String var1, int var2, int var3, int var4, int var5, int[] var6) {
		if (var1 != null) {
			this.reset(var4, var5);
			int[] var7 = null;
			if (var6 != null) {
			...
			this.method2088(var1, var2, var3, var7, (int[])null, (int[])null);
		}
	}

	@ObfuscatedName("bf")
	int[] method2082(int[] var1, int var2) {
		if (var2 == 0) {
			return null;
		} else {
	...
	public void drawRandomAlphaAndSpacing(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) {
			...
			this.method2088(var1, var2, var3, (int[])null, var7, (int[])null);
		}
	}
	...
	void decodeTag(String var1) {
		try {
			if (var1.startsWith("col=")) {
				AbstractFont_color = class148.method771(var1.substring(4), 16);
			} else if (var1.equals("/col")) {
				AbstractFont_color = AbstractFont_previousColor;
			} else if (var1.startsWith("str=")) {
				AbstractFont_strike = class148.method771(var1.substring(4), 16);
			} else if (var1.equals("str")) {
				AbstractFont_strike = 8388608;
			} else if (var1.equals("/str")) {
				AbstractFont_strike = -1;
			} else if (var1.startsWith("u=")) {
				AbstractFont_underline = class148.method771(var1.substring(2), 16);
			} else if (var1.equals("u")) {
				AbstractFont_underline = 0;
			} else if (var1.equals("/u")) {
				AbstractFont_underline = -1;
			} else if (var1.startsWith("shad=")) {
				AbstractFont_shadow = class148.method771(var1.substring(5), 16);
				...
				if (var7 == '<') {
						...
						if (var8.equals("lt")) {
							...
							if (!var8.equals("gt")) {
								if (var8.startsWith("img=")) {
									try {
										var9 = TextureProvider.method1301(var8.substring(4));
					...
					if (var4 == -1) {
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.method2593(var2, var3 + (int)((double)this.ascent * 0.7D), var13, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) {
							Rasterizer2D.method2593(var2, var3 + this.ascent + 1, var13, AbstractFont_underline);
						}
	...
	@ObfuscatedName("be")
	void method2088(String var1, int var2, int var3, int[] var4, int[] var5, int[] var6) {
		var3 -= this.ascent;
		int var7 = -1;
		int var8 = -1;
		int var9 = 0;
			...
			if (var1.charAt(var10) != 0) {
				...
				if (var11 == '<') {
							...
							if (!var12.equals("gt")) {
								if (var12.startsWith("img=")) {
									try {
										...
										++var9;
										var15 = TextureProvider.method1301(var12.substring(4));
					...
					if (var7 == -1) {
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.method2593(var2, var3 + (int)((double)this.ascent * 0.7D), var17, AbstractFont_strike);
						}

						if (AbstractFont_underline != -1) {
							Rasterizer2D.method2593(var2, var3 + this.ascent, var17, AbstractFont_underline);
						}
	...
	@ObfuscatedName("aj")
	static int method2062(byte[][] var0, byte[][] var1, int[] var2, int[] var3, int[] var4, int var5, int var6) {
		int var7 = var2[var5];
