...
public class World {
	...
	public static boolean method379(AbstractArchive var0, AbstractArchive var1) {
		...
		if (!var0.isFullyLoaded()) {
			...
			for (int var2 = 0; var2 < class11.WorldMapElement_count; ++var2) {
				...
				if (var3 != null) {
					...
					WorldMapElement.WorldMapElement_cached[var2].method940();
				}
			}
	...
	static void method390(float[] var0) {
		if (var0[0] + class125.field1183 < 1.3333334F) {
			...
			if (var0[1] + class125.field1183 > var4) {
				var0[1] = var4 - class125.field1183;
			} else {
				var4 = 0.5F * (-var1 - var3);
				if (var0[1] < var4 + class125.field1183) {
					var0[1] = var4 + class125.field1183;
				}
			}
		} else {
			var0[0] = 1.3333334F - class125.field1183;
			var0[1] = 0.33333334F - class125.field1183;
		}
	...
	static double method378(int var0, int var1, int var2) {
