...
public final class WorldMapManager {
	...
	public void load(AbstractArchive var1, String var2, boolean var3) {
		if (!this.loadStarted) {
			...
			System.nanoTime();
			int var4 = var1.getGroupId(WorldMapCacheName.field2447.name);
			int var5 = var1.getFileId(var4, var2);
			Buffer var6 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2447.name, var2));
			Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2446.name, var2));
			System.nanoTime();
			System.nanoTime();
			...
			System.nanoTime();
			System.nanoTime();
			if (var1.isValidFileName(WorldMapCacheName.field2448.name, var2)) {
				byte[] var20 = var1.takeFileByNames(WorldMapCacheName.field2448.name, var2);
				this.compositeTextureSprite = Interpreter.method412(var20);
			}
	...
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		float[] var12 = Rasterizer2D.field4122;
		int[] var13 = new int[4];
		...
		int var24 = var14.field_56 + var14.width - 1;
		int var18 = var14.height + var14.field_57 - 1;

		int var19;
		int var20;
		for (var19 = var14.field_56; var19 <= var24; ++var19) {
			for (var20 = var14.field_57; var20 <= var18; ++var20) {
		...
		Rasterizer3D.method1195(var9, var10, var11, var12);
		Rasterizer2D.Rasterizer2D_setClipArray(var13);
		var19 = (int)(var15 * 64.0F);
		var20 = this.tileX + var1;
		int var21 = var2 + this.tileY;

		for (int var22 = var14.field_56; var22 < var14.width + var14.field_56; ++var22) {
			for (int var23 = var14.field_57; var23 < var14.height + var14.field_57; ++var23) {
				this.regions[var22][var23].method1441(var5 + (this.regions[var22][var23].regionX * 64 - var20) * var19 / 64, var8 - (this.regions[var22][var23].regionY * 64 - var21 + 64) * var19 / 64, var19);
			}
		}
	...
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		int var19;
		int var20;
		for (var19 = var14.field_56; var19 < var14.width + var14.field_56; ++var19) {
			for (var20 = var14.field_57; var20 < var14.field_57 + var14.height; ++var20) {
				if (var13) {
					this.regions[var19][var20].initWorldMapIcon1s();
				}

				this.regions[var19][var20].method1451(var5 + (this.regions[var19][var20].regionX * 64 - var17) * var16 / 64, var8 - (this.regions[var19][var20].regionY * 64 - var18 + 64) * var16 / 64, var16, var9);
			}
		}
			...
			if (var6 > 0 && var6 % var7 < var7 / 2) {
				...
				while (true) {
					...
					while (var11.hasNext()) {
						...
						int var13 = var3 * (var12.coord2.field_46 - this.tileX) / this.tileWidth;
						int var14 = var4 - (var12.coord2.field_47 - this.tileY) * var4 / this.tileHeight;
	...
	public List method1482(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		...
		if (!this.loaded) {
			...
			for (int var17 = var12.field_56; var17 < var12.width + var12.field_56; ++var17) {
				for (int var18 = var12.field_57; var18 < var12.field_57 + var12.height; ++var18) {
					List var19 = this.regions[var17][var18].method1472(var5 + (this.regions[var17][var18].regionX * 64 - var15) * var14 / 64, var8 + var6 - (this.regions[var17][var18].regionY * 64 - var16 + 64) * var14 / 64, var14, var9, var10);
					if (!var19.isEmpty()) {
						var11.addAll(var19);
					}
				}
	...
	WorldMapRectangle createWorldMapRectangle(int var1, int var2, int var3, int var4) {
		...
		var5.field_56 = var10 - this.mapAreaData.getRegionLowX();
		var5.field_57 = var11 - this.mapAreaData.getRegionLowY();
		if (var5.field_56 < 0) {
			var5.width += var5.field_56;
			var5.field_56 = 0;
		}

		if (var5.field_56 > this.regions.length - var5.width) {
			var5.width = this.regions.length - var5.field_56;
		}

		if (var5.field_57 < 0) {
			var5.height += var5.field_57;
			var5.field_57 = 0;
		}

		if (var5.field_57 > this.regions[0].length - var5.height) {
			var5.height = this.regions[0].length - var5.field_57;
		}
