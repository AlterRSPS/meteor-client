...
public class ScriptEvent extends Node {
	...
	public void method457(Widget var1) {
		this.widget = var1;
	}
	...
	public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var22 == null) {
			...
			float[] var15 = Rasterizer2D.field4122;
			int[] var16 = new int[4];
			Rasterizer2D.Rasterizer2D_getClipArray(var16);
			var8 = new SpritePixels(36, 32);
			Rasterizer3D.method1195(var8.pixels, 36, 32, (float[])null);
			Rasterizer2D.Rasterizer2D_clear();
			Rasterizer3D.method1196();
			Rasterizer3D.method1199(16, 16);
			Rasterizer3D.field2014.field2257 = false;
			...
			Rasterizer3D.method1195(var12, var13, var14, var15);
			Rasterizer2D.Rasterizer2D_setClipArray(var16);
			Rasterizer3D.method1196();
			Rasterizer3D.field2014.field2257 = true;
			return var8;
		}
	}
	...
	static final void method459(int var0, int var1, int var2, int var3) {
		Client.field488 = 0;
		int var4 = (Projectile.localPlayer.field_27 >> 7) + class213.baseX;
		...
		if (Client.field488 == 1 && var4 >= 3139 && var4 <= 3199 && var5 >= 3008 && var5 <= 3062) {
			Client.field488 = 0;
		}
