...
public class VarpDefinition extends DualNode {
	...
	static final void method935(Scene var0, CollisionMap[] var1) {
		int var2;
		int var3;
		int var4;
		int var5;
		...
		int var18;
		for (var2 = 0; var2 < 4; ++var2) {
			byte[][] var47 = class305.field2754[var2];
			boolean var56 = true;
			boolean var57 = true;
			boolean var6 = true;
			boolean var7 = true;
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					...
					Canvas.field66[var12][var11] = var19 - var55;
				}
			}
			...
			for (var11 = -5; var11 < 109; ++var11) {
				for (var12 = 0; var12 < 104; ++var12) {
					...
					if (var13 >= 0 && var13 < 104) {
						...
						if (var17 > 0) {
							FloorUnderlayDefinition var50 = class183.method925(var17 - 1);
							...
							var10002 = Tiles.field837[var12]++;
						}
					}

					var14 = var11 - 5;
					if (var14 >= 0 && var14 < 104) {
						var15 = (int)class215.method1146(15);
						var16 = FaceNormal.Tiles_underlays[var2][var14][var12] & var15;
						if (var16 > 0) {
							FloorUnderlayDefinition var54 = class183.method925(var16 - 1);
							var10000 = UserComparator5.Tiles_hue;
					...
					for (var17 = -5; var17 < 109; ++var17) {
						...
						if (var17 >= 1 && var17 < 103 && (!Client.isLowDetail || (Tiles.Tiles_renderFlags[0][var11][var17] & 2) != 0 || (Tiles.Tiles_renderFlags[var2][var11][var17] & 16) == 0)) {
							...
							if (var23 > 0 || var24 > 0) {
								...
								int var29 = Canvas.field66[var11][var17];
								int var30 = Canvas.field66[var11 + 1][var17];
								int var31 = Canvas.field66[var11 + 1][var17 + 1];
								int var32 = Canvas.field66[var11][var17 + 1];
								int var33 = -1;
								int var34 = -1;
								int var35;
								int var36;
								...
								if (var23 > 0) {
									...
									var36 = var13 / var16;
									var37 = var14 / var16;
									var33 = GameEngine.method149(var35, var36, var37);
									...
									var34 = GameEngine.method149(var35, var36, var37);
								}
								...
								if (var2 > 0) {
									...
									if (var62 && var25 == var26 && var25 == var27 && var25 == var28) {
										var10000 = Tiles.field838[var2][var11];
										var10000[var17] |= 2340;
									}
								}
								...
								var35 = 0;
								if (var34 != -1) {
									var35 = Rasterizer3D.Rasterizer3D_colorPalette[ItemContainer.method449(var34, 96)];
								}

								if (var24 == 0) {
									var0.addTile(var2, var11, var17, 0, 0, -1, var25, var26, var27, var28, ItemContainer.method449(var33, var29), ItemContainer.method449(var33, var30), ItemContainer.method449(var33, var31), ItemContainer.method449(var33, var32), 0, 0, 0, 0, var35, 0);
								} else {
									var36 = Player.Tiles_shapes[var2][var11][var17] + 1;
									byte var63 = Tiles.field831[var2][var11][var17];
									int var52 = var24 - 1;
									...
									int var45;
									if (var53 >= 0) {
										var43 = Rasterizer3D.field2014.Rasterizer3D_textureLoader.getAverageTextureRGB(var53);
										var42 = -1;
										...
										var42 = GameEngine.method149(var38.hue, var38.saturation, var38.lightness);
										...
										var43 = GameEngine.method149(var44, var38.saturation, var45);
									}

									var44 = 0;
									if (var43 != -2) {
										var44 = Rasterizer3D.Rasterizer3D_colorPalette[AbstractSocket.method2214(var43, 96)];
									}
									...
									if (var38.secondaryRgb != -1) {
										...
										var43 = GameEngine.method149(var45, var38.secondarySaturation, var46);
										var44 = Rasterizer3D.Rasterizer3D_colorPalette[AbstractSocket.method2214(var43, 96)];
									}

									var0.addTile(var2, var11, var17, var36, var63, var53, var25, var26, var27, var28, ItemContainer.method449(var33, var29), ItemContainer.method449(var33, var30), ItemContainer.method449(var33, var31), ItemContainer.method449(var33, var32), AbstractSocket.method2214(var42, var29), AbstractSocket.method2214(var42, var30), AbstractSocket.method2214(var42, var31), AbstractSocket.method2214(var42, var32), var35, var44);
								}
							}
						}
					}
			...
			for (var11 = 1; var11 < 103; ++var11) {
				for (var12 = 1; var12 < 103; ++var12) {
					var0.setTileMinPlane(var2, var12, var11, class135.method716(var2, var12, var11));
				}
			}
			...
			Tiles.field831[var2] = null;
			class305.field2754[var2] = null;
		}

		var0.method1259(-50, -10, -50);
			...
			for (int var58 = 0; var58 <= var5; ++var58) {
				for (int var59 = 0; var59 <= 104; ++var59) {
					for (int var60 = 0; var60 <= 104; ++var60) {
						short var61;
						if ((Tiles.field838[var58][var60][var59] & var2) != 0) {
							var9 = var59;
							var10 = var59;
							var11 = var58;

							for (var12 = var58; var9 > 0 && (Tiles.field838[var58][var60][var9 - 1] & var2) != 0; --var9) {
							}

							while (var10 < 104 && (Tiles.field838[var58][var60][var10 + 1] & var2) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((Tiles.field838[var11 - 1][var60][var13] & var2) == 0) {
										break label355;
									}
								}
							...
							while (var12 < var5) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((Tiles.field838[var12 + 1][var60][var13] & var2) == 0) {
										break label344;
									}
								}
							...
							if (var13 >= 8) {
								...
								for (var17 = var11; var17 <= var12; ++var17) {
									for (var18 = var9; var18 <= var10; ++var18) {
										var10000 = Tiles.field838[var17][var60];
										var10000[var18] &= ~var2;
									}
								}
							}
						...
						if ((Tiles.field838[var58][var60][var59] & var3) != 0) {
							var9 = var60;
							var10 = var60;
							var11 = var58;

							for (var12 = var58; var9 > 0 && (Tiles.field838[var58][var9 - 1][var59] & var3) != 0; --var9) {
							}

							while (var10 < 104 && (Tiles.field838[var58][var10 + 1][var59] & var3) != 0) {
								++var10;
							}
							...
							while (var11 > 0) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((Tiles.field838[var11 - 1][var13][var59] & var3) == 0) {
										break label408;
									}
								}
							...
							while (var12 < var5) {
								for (var13 = var9; var13 <= var10; ++var13) {
									if ((Tiles.field838[var12 + 1][var13][var59] & var3) == 0) {
										break label397;
									}
								}
							...
							if (var13 >= 8) {
								...
								for (var17 = var11; var17 <= var12; ++var17) {
									for (var18 = var9; var18 <= var10; ++var18) {
										var10000 = Tiles.field838[var17][var18];
										var10000[var59] &= ~var3;
									}
								}
							}
						...
						if ((Tiles.field838[var58][var60][var59] & var4) != 0) {
							var9 = var60;
							var10 = var60;
							var11 = var59;

							for (var12 = var59; var11 > 0 && (Tiles.field838[var58][var60][var11 - 1] & var4) != 0; --var11) {
							}

							while (var12 < 104 && (Tiles.field838[var58][var60][var12 + 1] & var4) != 0) {
								++var12;
							}
							...
							while (var9 > 0) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((Tiles.field838[var58][var9 - 1][var13] & var4) == 0) {
										break label461;
									}
								}
							...
							while (var10 < 104) {
								for (var13 = var11; var13 <= var12; ++var13) {
									if ((Tiles.field838[var58][var10 + 1][var13] & var4) == 0) {
										break label450;
									}
								}
							...
							if ((var12 - var11 + 1) * (var10 - var9 + 1) >= 4) {
								...
								for (var14 = var9; var14 <= var10; ++var14) {
									for (var15 = var11; var15 <= var12; ++var15) {
										var10000 = Tiles.field838[var58][var14];
										var10000[var15] &= ~var4;
									}
								}
							}
	...
	static int method936(int var0, Script var1, boolean var2) {
