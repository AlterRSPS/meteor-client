...
public abstract class AbstractArchive {
	...
	void decodeIndex(byte[] var1) {
		this.hash = class196.method990(var1, var1.length);
		...
		if (var3 >= 5 && var3 <= 7) {
			...
			if (var3 >= 7) {
				this.groupCount = var2.method2517();
			} else {
			...
			if (var3 >= 7) {
				for (var7 = 0; var7 < this.groupCount; ++var7) {
					this.groupIds[var7] = var5 += var2.method2517();
			...
			if (var3 >= 7) {
				for (var7 = 0; var7 < this.groupCount; ++var7) {
					...
					for (var11 = 0; var11 < var9; ++var11) {
						var12 = this.fileIds[var8][var11] = var5 += var2.method2517();
						if (var12 > var10) {
							var10 = var12;
						}
					}
	...
	public byte[] takeFileEncrypted(int var1, int var2, int[] var3) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var5 = Varps.method1699(this.files[var1][var2], false);
	...
	public boolean method1902(int var1) {
	...
	public byte[] getFile(int var1, int var2) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var4 = Varps.method1699(this.files[var1][var2], false);
			return var4;
		} else {
			return null;
		}
		...
		if (this.groups[var1] == null) {
			...
			if (var6) {
				...
				if (var2 != null && (var2[0] != 0 || var2[1] != 0 || var2[2] != 0 || var2[3] != 0)) {
					var18 = Varps.method1699(this.groups[var1], true);
					Buffer var8 = new Buffer(var18);
					var8.xteaDecrypt(var2, 5, var8.array.length);
				} else {
					var18 = Varps.method1699(this.groups[var1], false);
				}
				...
				if (var3 > 1) {
					...
					for (var15 = 0; var15 < var3; ++var15) {
						if (!this.shallowFiles) {
							var5[var4[var15]] = class104.method594(var19[var15], false);
						} else {
							var5[var4[var15]] = var19[var15];
						}
					}
				} else if (!this.shallowFiles) {
					var5[var4[0]] = class104.method594(var20, false);
				} else {
					var5[var4[0]] = var20;
				}
	...
	static float method1897(class440 var0, float var1, float var2, float var3) {
		float var4 = FriendLoginUpdate.method2168(var0.field3827, var0.field3828, var1);
		if (Math.abs(var4) < class125.field1183) {
			return var1;
		} else {
			float var5 = FriendLoginUpdate.method2168(var0.field3827, var0.field3828, var2);
			if (Math.abs(var5) < class125.field1183) {
				return var2;
			} else {
				float var6 = 0.0F;
				float var7 = 0.0F;
				...
				do {
					...
					float var16 = class125.field1184 * Math.abs(var2) + var3 * 0.5F;
					...
					if (var18) {
						...
						var5 = FriendLoginUpdate.method2168(var0.field3827, var0.field3828, var2);
