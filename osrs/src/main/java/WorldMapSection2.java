...
public class WorldMapSection2 implements WorldMapSection {
	...
	public void expandBounds(WorldMapArea var1) {
		if (var1.regionLowX > this.field2310) {
			var1.regionLowX = this.field2310;
		}

		if (var1.regionHighX < this.field2311) {
			var1.regionHighX = this.field2311;
		}

		if (var1.regionLowY > this.field2313) {
			var1.regionLowY = this.field2313;
		}

		if (var1.regionHighY < this.field2312) {
			var1.regionHighY = this.field2312;
		}
	...
	public boolean containsPosition(int var1, int var2) {
		return var1 >> 6 >= this.field2310 && var1 >> 6 <= this.field2311 && var2 >> 6 >= this.field2313 && var2 >> 6 <= this.field2312;
	}
	...
	public int[] getBorderTileLengths(int var1, int var2, int var3) {
		if (!this.containsCoord(var1, var2, var3)) {
			...
			int[] var4 = new int[]{var2 + (this.field2310 * 64 - this.regionStartX * 64), var3 + (this.field2313 * 64 - this.regionStartY * 64)};
			return var4;
		}
	}
	...
	public Coord coord(int var1, int var2) {
		if (!this.containsPosition(var1, var2)) {
			...
			int var3 = this.regionStartX * 64 - this.field2310 * 64 + var1;
			int var4 = var2 + (this.regionStartY * 64 - this.field2313 * 64);
	...
	static final int method1413(long var0, String var2) {
		...
		var4.encryptRsa(class72.field728, class72.field727);
		var5.writeByte(10);
		...
		if (Client.randomDatData != null) {
			...
			byte[] var18 = WorldMapCacheName.method1555();
			var5.writeBytes(var18, 0, var18.length);
		}

		var5.writeLong(var3.nextLong());
		var5.encryptRsa(class72.field728, class72.field727);
		...
		String var10 = Archive.method1886(var11, 0, var11.length);
		String var12 = var10;

		try {
			URL var13 = new URL(Widget.method1853("services", false) + "m=accountappeal/login.ws");
			...
			var15.write("data2=" + class347.method1873(var12) + "&dest=" + class347.method1873("passwordchoice.ws"));
			var15.flush();
			...
			do {
				...
				if (var17 == -1) {
					...
					if (var19.startsWith("OFFLINE")) {
						...
						if (ItemComposition.method1048(var19)) {
	...
	public static boolean method1415() {
		try {
			if (class304.musicPlayerStatus == 2) {
				...
				if (class304.midiPcmStream.method1626(class237.musicTrack, class304.field2746, class304.soundCache)) {
					class304.midiPcmStream.method1627();
					...
					PriorityQueue var0 = class304.midiPcmStream.field2784;
					if (var0 != null) {
						if (class304.field2750 != null) {
							class304.field2750.set(true);
						}

						class304.field2750 = new AtomicBoolean(false);
						AtomicBoolean var1 = class304.field2750;
						if (class304.field2749 == null) {
							int var2 = Runtime.getRuntime().availableProcessors();
							class304.field2749 = new ThreadPoolExecutor(0, var2, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(), new class305());
						}

						class304.field2749.submit(new class309(var0, var1));
					}

					class304.field2740 = VarbitComposition.musicTrackGroupId;
					class304.field2742 = class304.musicTrackFileId;
	...
	static int method1416(int var0, Script var1, boolean var2) {
		...
		if (var0 == 1700) {
			...
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var3.childIndex * 112312013;
			return 1;
		} else if (var0 == 1707) {
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var3.method1837() ? 1 : 0;
			return 1;
		} else if (var0 == 1708) {
			return MenuAction.method422(var3);
		} else {
			return var0 == 1709 ? class10.method40(var3) : 2;
		}
	}
