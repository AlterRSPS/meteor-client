...
public class CollisionMap {
	...
	public void method1115(int var1, int var2, int var3, int var4, boolean var5) {
		var1 -= this.xInset;
		var2 -= this.yInset;
		if (var3 == 0) {
			if (var4 == 0) {
	...
	@ObfuscatedSignature(
		descriptor = "(IIIIZI)V",
		garbageValue = "1015647112"
	)
	public void method1121(int var1, int var2, int var3, int var4, boolean var5) {
		var1 -= this.xInset;
		var2 -= this.yInset;
		if (var3 == 0) {
			if (var4 == 0) {
	...
	public void method1124(int var1, int var2) {
		var1 -= this.xInset;
		var2 -= this.yInset;
		int[] var10000 = this.flags[var1];
	...
	@ObfuscatedName("ap")
	@ObfuscatedSignature(
		descriptor = "(Lnq;Ljava/lang/String;Ljava/lang/String;B)[Ltm;",
		garbageValue = "-1"
	)
	public static SpritePixels[] method1116(AbstractArchive var0, String var1, String var2) {
		if (!var0.isValidFileName(var1, var2)) {
			return null;
		} else {
			int var3 = var0.getGroupId(var1);
			int var4 = var0.getFileId(var3, var2);
			return WorldMapScaleHandler.method1567(var0, var3, var4);
		}
	}
}
