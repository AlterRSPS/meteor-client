...
public class ModelData extends Renderable {
	...
	static {
		field1920 = new int[10000];
		field1922 = new int[10000];
		field1918 = 0;
	...
	public ModelData(ModelData[] var1, int var2) {
		...
		if (var9) {
			this.field1948 = new int[this.verticesCount][];
			this.field1949 = new int[this.verticesCount][];
		}
		...
		for (var10 = 0; var10 < var2; ++var10) {
			...
			if (var11 != null) {
				...
				for (var12 = 0; var12 < var11.faceCount; ++var12) {
					...
					this.indices1[this.faceCount] = this.method1156(var11, var11.indices1[var12]);
					this.indices2[this.faceCount] = this.method1156(var11, var11.indices2[var12]);
					this.indices3[this.faceCount] = this.method1156(var11, var11.indices3[var12]);
					++this.faceCount;
				}
				...
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) {
					...
					if (var13 == 0) {
						this.texTriangleX[this.textureTriangleCount] = (short)this.method1156(var11, var11.texTriangleX[var12]);
						this.texTriangleY[this.textureTriangleCount] = (short)this.method1156(var11, var11.texTriangleY[var12]);
						this.texTriangleZ[this.textureTriangleCount] = (short)this.method1156(var11, var11.texTriangleZ[var12]);
					}
	...
	void method1152(byte[] var1) {
		...
		if (var18 == 1) {
			for (var53 = 0; var53 < var9; ++var53) {
				...
				this.field1948[var53] = new int[var54];
				this.field1949[var53] = new int[var54];

				for (var55 = 0; var55 < var54; ++var55) {
					this.field1948[var53][var55] = var6.readUnsignedByte();
					this.field1949[var53][var55] = var6.readUnsignedByte();
				}
			}
		}
	...
	void method1153(byte[] var1) {
		...
		if (var17 == 1) {
			for (var40 = 0; var40 < var9; ++var40) {
				...
				this.field1948[var40] = new int[var41];
				this.field1949[var40] = new int[var41];

				for (var42 = 0; var42 < var41; ++var42) {
					this.field1948[var40][var42] = var8.readUnsignedByte();
					this.field1949[var40][var42] = var8.readUnsignedByte();
				}
			}
		}
	...
	final int method1156(ModelData var1, int var2) {
		int var3 = -1;
		...
		if (var3 == -1) {
			...
			if (var1.field1948 != null) {
				this.field1948[this.verticesCount] = var1.field1948[var2];
				this.field1949[this.verticesCount] = var1.field1949[var2];
			}
	...
	public ModelData method1158(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		this.calculateBounds();
		int var7 = var2 + this.field1934;
		int var8 = var2 + this.field1938;
		int var9 = var4 + this.field1936;
		int var10 = var4 + this.field1935;
		...
		if (this.vertexNormals == null) {
			...
			for (var1 = 0; var1 < this.faceCount; ++var1) {
				...
				if (var15 == 0) {
					...
					var16.field_42 += var11;
					var16.field_43 += var12;
					var16.field_44 += var13;
					++var16.magnitude;
					...
					var17.field_50 = var11;
					var17.field_51 = var12;
					var17.field_52 = var13;
				}
			}
	...
	void calculateBounds() {
		if (!this.isBoundsCalculated) {
			super.height = 0;
			this.field1937 = 0;
			this.field1934 = 999999;
			this.field1938 = -999999;
			this.field1935 = -99999;
			this.field1936 = 99999;

			for (int var1 = 0; var1 < this.verticesCount; ++var1) {
				int var2 = this.verticesX[var1];
				int var3 = this.verticesY[var1];
				int var4 = this.verticesZ[var1];
				if (var2 < this.field1934) {
					this.field1934 = var2;
				}

				if (var2 > this.field1938) {
					this.field1938 = var2;
				}
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) {
			...
			var8.field2203 = new int[var8.field2222];
			var8.field2204 = new int[var8.field2222];
			var8.field2207 = new int[var8.field2222];
			var10 = 0;

			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) {
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
					var8.field2203[var10] = this.texTriangleX[var11] & '\uffff';
					var8.field2204[var10] = this.texTriangleY[var11] & '\uffff';
					var8.field2207[var10] = this.texTriangleZ[var11] & '\uffff';
					var9[var11] = var10++;
				} else {
					var9[var11] = -1;
				}
			...
			var8.field2188 = new byte[this.faceCount];

			for (var11 = 0; var11 < this.faceCount; ++var11) {
				if (this.textureCoords[var11] != -1) {
					var8.field2188[var11] = (byte)var9[this.textureCoords[var11] & 255];
				} else {
					var8.field2188[var11] = -1;
				}
			}
		}
			...
			if (var12 == -1) {
				if (var17 != 0) {
					if (var17 == 1) {
						...
						var14 = (var4 * var19.field_51 + var5 * var19.field_52 + var3 * var19.field_50) / (var7 / 2 + var7) + var1;
						var8.faceColors1[var16] = method1174(this.faceColors[var16] & '\uffff', var14);
					...
					var14 = (var4 * var13.field_43 + var5 * var13.field_44 + var3 * var13.field_42) / (var7 * var13.magnitude) + var1;
					var8.faceColors1[var16] = method1174(var15, var14);
					...
					var14 = (var4 * var13.field_43 + var5 * var13.field_44 + var3 * var13.field_42) / (var7 * var13.magnitude) + var1;
					var8.faceColors2[var16] = method1174(var15, var14);
					...
					var14 = (var4 * var13.field_43 + var5 * var13.field_44 + var3 * var13.field_42) / (var7 * var13.magnitude) + var1;
					var8.faceColors3[var16] = method1174(var15, var14);
				}
			} else if (var17 != 0) {
				if (var17 == 1) {
					var19 = this.faceNormals[var16];
					var14 = (var4 * var19.field_51 + var5 * var19.field_52 + var3 * var19.field_50) / (var7 / 2 + var7) + var1;
					var8.faceColors1[var16] = method1175(var14);
					var8.faceColors3[var16] = -1;
				} else {
					var8.faceColors3[var16] = -2;
				}
				...
				var14 = (var4 * var13.field_43 + var5 * var13.field_44 + var3 * var13.field_42) / (var7 * var13.magnitude) + var1;
				var8.faceColors2[var16] = method1175(var14);
				if (this.vertexVertices != null && this.vertexVertices[this.indices3[var16]] != null) {
					var13 = this.vertexVertices[this.indices3[var16]];
				} else {
					var13 = this.vertexNormals[this.indices3[var16]];
				...
				var14 = (var4 * var13.field_43 + var5 * var13.field_44 + var3 * var13.field_42) / (var7 * var13.magnitude) + var1;
				var8.faceColors3[var16] = method1175(var14);
			}
		}
	...
	@ObfuscatedName("am")
	@ObfuscatedSignature(
		descriptor = "(Lit;Lit;IIIZ)V"
	)
	static void method1172(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		for (var9 = 0; var9 < var0.verticesCount; ++var9) {
			...
			if (var10.magnitude != 0) {
				...
				if (var11 <= var1.field1937) {
					int var12 = var0.verticesX[var9] - var2;
					if (var12 >= var1.field1934 && var12 <= var1.field1938) {
						int var13 = var0.verticesZ[var9] - var4;
						if (var13 >= var1.field1936 && var13 <= var1.field1935) {
							for (int var14 = 0; var14 < var8; ++var14) {
								...
								if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) {
									...
									var16.field_42 += var15.field_42;
									var16.field_43 += var15.field_43;
									var16.field_44 += var15.field_44;
									var16.magnitude += var15.magnitude;
									var17.field_42 += var10.field_42;
									var17.field_43 += var10.field_43;
									var17.field_44 += var10.field_44;
									var17.magnitude += var10.magnitude;
									++var6;
									field1920[var9] = field1918;
									field1922[var14] = field1918;
								}
							}
						}
					}
		...
		if (var6 >= 3 && var5) {
			for (var9 = 0; var9 < var0.faceCount; ++var9) {
				if (field1920[var0.indices1[var9]] == field1918 && field1920[var0.indices2[var9]] == field1918 && field1920[var0.indices3[var9]] == field1918) {
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) {
				if (field1918 == field1922[var1.indices1[var9]] && field1918 == field1922[var1.indices2[var9]] && field1918 == field1922[var1.indices3[var9]]) {
	...
	@ObfuscatedName("bc")
	static final int method1174(int var0, int var1) {
	...
	@ObfuscatedName("bj")
	static final int method1175(int var0) {
		if (var0 < 2) {
			var0 = 2;
		} else if (var0 > 126) {
			var0 = 126;
