...
public class JSONArray {
	...
	public JSONArray(Object var1) throws JSONException {
		...
		if (!var1.getClass().isArray()) {
			...
			for (int var3 = 0; var3 < var2; ++var3) {
				this.method2662(Array.get(var1, var3));
			}
	...
	public JSONArray(Object var1, boolean var2) throws JSONException {
		...
		if (!var1.getClass().isArray()) {
			...
			for (int var4 = 0; var4 < var3; ++var4) {
				this.method2662(new JSONObject(Array.get(var1, var4), var2));
			}
	...
	@ObfuscatedName("opt")
	public Object method2661(int var1) {
		return var1 >= 0 && var1 < this.length() ? this.myArrayList.get(var1) : null;
	}

	@ObfuscatedName("get")
	public Object method2660(int var1) throws JSONException {
		Object var2 = this.method2661(var1);
		if (var2 == null) {
	...
	public JSONArray method2662(Object var1) {
	...
	public double getDouble(int var1) throws JSONException {
		Object var2 = this.method2660(var1);
