...
public class WorldMap {
	...
	public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4, HashMap var5, IndexedSprite[] var6) {
		...
		int var7 = this.WorldMap_archive.getGroupId(WorldMapCacheName.field2447.name);
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) {
			...
			if (var3) {
				...
				List var10 = this.worldMapManager.method1482(this.centerTileX - var8 / 2 - 1, this.centerTileY - var9 / 2 - 1, var8 / 2 + this.centerTileX + 1, var9 / 2 + this.centerTileY + 1, var4, var5, var6, var7, var1, var2);
				...
				for (var12 = var10.iterator(); var12.hasNext(); Clock.runScriptEvent(var14)) {
					...
					if (this.field3956.contains(var13)) {
						var14.setType(17);
					} else {
						var14.setType(15);
					}
	...
	public void method2340(int var1, int var2, boolean var3, boolean var4) {
		long var5;
		label33: {
			var5 = BoundaryObject.clockNow();
			this.method2341(var1, var2, var4, var5);
			if (!this.hasTarget() && (var4 || var3)) {
				...
				if (!var7) {
					if (var4) {
						this.field3935 = var1;
						this.field3941 = var2;
						this.field3943 = this.centerTileX;
						this.field3932 = this.centerTileY;
					}

					if (this.field3943 != -1) {
						int var8 = var1 - this.field3935;
						int var9 = var2 - this.field3941;
						this.setWorldMapPosition(this.field3943 - (int)((float)var8 / this.zoomTarget), (int)((float)var9 / this.zoomTarget) + this.field3932, false);
					}
					break label33;
				}
			}
	...
	@ObfuscatedName("ax")
	void method2341(int var1, int var2, boolean var3, long var4) {
		if (this.currentMapArea != null) {
			...
			if (this.mouseCoord != null && var3) {
				class211 var8 = class350.method1877();
				int var10;
				int var11;
				if (RouteStrategy.method1131() && var8.getKeyPressed(82) && var8.getKeyPressed(81)) {
					int var14 = this.mouseCoord.field_46;
					var10 = this.mouseCoord.field_47;
					var11 = this.mouseCoord.plane;
					PacketBufferNode var12 = ObjectComposition.getPacketBufferNode(ClientPacket.field2566, Client.packetWriter.isaacCipher);
					var12.packetBuffer.method2537(var10);
					var12.packetBuffer.writeByte(var11);
					var12.packetBuffer.method2539(var14);
					var12.packetBuffer.writeShortAdd(0);
					Client.packetWriter.addNode(var12);
				} else {
					boolean var9 = true;
					if (this.field3923) {
						var10 = var1 - this.field3936;
						var11 = var2 - this.field3938;
						if (var4 - this.field3963 > 500L || var10 < -25 || var10 > 25 || var11 < -25 || var11 > 25) {
							var9 = false;
						}
					}

					if (var9) {
						PacketBufferNode var13 = ObjectComposition.getPacketBufferNode(ClientPacket.field2512, Client.packetWriter.isaacCipher);
	...
	public void method2348(int var1, int var2, int var3, boolean var4) {
	...
	public void method2354(WorldMapArea var1, Coord var2, Coord var3, boolean var4) {
		if (var1 != null) {
			if (this.currentMapArea == null || var1 != this.currentMapArea) {
				this.initializeWorldMapManager(var1);
			}

			if (!var4 && this.currentMapArea.containsCoord(var2.plane, var2.field_46, var2.field_47)) {
				this.jump(var2.plane, var2.field_46, var2.field_47);
			} else {
				this.jump(var3.plane, var3.field_46, var3.field_47);
			}
	...
	public void draw(int var1, int var2, int var3, int var4, int var5) {
		...
		if (var7 < 100) {
			...
			if (!this.elementsDisabled) {
				boolean var10 = false;
				if (var5 - this.field3947 > 100) {
					this.field3947 = var5;
					var10 = true;
				}

				this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4, this.field3953, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
			}

			this.method2358(var1, var2, var3, var4, var8, var9);
			if (RouteStrategy.method1131() && this.showCoord && this.mouseCoord != null) {
	...
	boolean method2357(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.sprite == null) {
			return true;
			...
			if (this.worldMapManager.pixelsPerTile != this.cachedPixelsPerTile) {
				return true;
			} else if (this.field3944 != Client.field366) {
				return true;
	...
	void method2358(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (class30.field82 != null) {
			...
			if (this.method2357(var8, var9, var13, var14, var3, var4)) {
				...
				class30.field82.method1946(this.minCachedTileX, this.minCachedTileY, this.sprite, (float)this.cachedPixelsPerTile / var10);
				this.field3944 = Client.field366;
			...
			if (1.0F == var10) {
				this.sprite.method2635(var13, var14, 192);
			} else {
				this.sprite.method2638(var13, var14, (int)((float)var8 * var10), (int)(var10 * (float)var9), 192);
			}
		}
	...
	void method2390() {
		...
		this.field3953.addAll(this.enabledElements);
		this.field3953.addAll(this.enabledElementIds);
	}
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) {
			...
			List var9 = this.worldMapManager.method1482(this.centerTileX - var7 / 2 - 1, this.centerTileY - var8 / 2 - 1, var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1, var1, var2, var3, var4, var5, var6);
			if (!var9.isEmpty()) {
	...
	public Coord method2392(int var1, Coord var2) {
		if (!this.cacheLoader.isLoaded()) {
			return null;
		} else if (!this.worldMapManager.isLoaded()) {
			return null;
		} else if (!this.currentMapArea.containsPosition(var2.field_46, var2.field_47)) {
			return null;
		} else {
			...
			if (var4 != null && !var4.isEmpty()) {
				...
				while (true) {
					...
					do {
						...
						int var9 = var8.coord2.field_46 - var2.field_46;
						int var10 = var8.coord2.field_47 - var2.field_47;
	...
	public AbstractWorldMapIcon iconStart() {
		if (!this.cacheLoader.isLoaded()) {
			...
			this.field3958 = new LinkedList();
			Iterator var2 = var1.values().iterator();

			while (var2.hasNext()) {
				List var3 = (List)var2.next();
				this.field3958.addAll(var3);
			}

			this.iconIterator = this.field3958.iterator();
