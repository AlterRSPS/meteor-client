...
public class Message extends DualNode {
	...
	void set(int var1, String var2, String var3, String var4) {
		this.count = MouseHandler.method156();
	...
	final void fillSenderUsername() {
		if (this.sender != null) {
			this.senderUsername = new Username(Canvas.method79(this.sender), WorldMapScaleHandler.loginType);
		} else {
	...
	static final void method335(int var0, int var1, int var2) {
		int var3;
	...
	static final boolean method337(int var0, int var1, int var2, int var3, int var4) {
		...
		for (PendingSpawn var6 = (PendingSpawn)Client.pendingSpawns.last(); var6 != null; var6 = (PendingSpawn)Client.pendingSpawns.previous()) {
			if (var0 == var6.plane && var6.field_3 == var1 && var2 == var6.field_4 && var3 == var6.type) {
				var5 = var6;
				break;
			}
		}
