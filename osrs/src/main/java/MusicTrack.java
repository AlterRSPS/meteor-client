...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		super();
		this.field2812 = new NodeHashTable(16);
					...
					if (var68 == 23) {
						...
						if (var66 == 0) {
							...
							if (var71 > 0) {
								...
								class316 var73 = (class316)this.field2812.get((long)var72);
								if (var73 == null) {
									var73 = new class316(var65);
									this.field2812.put(var73, (long)var72);
								}

								var73.field2837.set(var74);
							}
						} else if (var66 == 1) {
							if (var69) {
