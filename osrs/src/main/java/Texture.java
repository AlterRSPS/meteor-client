...
public class Texture extends Node {
	...
	Texture(Buffer var1) {
		...
		this.field1968 = var1.readUnsignedByte() == 1;
		...
		if (var2 >= 1 && var2 <= 4) {
			...
			if (var2 > 1) {
				this.field1976 = new int[var2 - 1];

				for (var3 = 0; var3 < var2 - 1; ++var3) {
					this.field1976[var3] = var1.readUnsignedByte();
				}
			}
			...
			for (var3 = 0; var3 < var2; ++var3) {
				this.field1974[var3] = var1.readInt();
			}
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) {
			...
			IndexedSprite var7;
			if (!Archive.method1895(var4, var8)) {
				var7 = null;
			} else {
