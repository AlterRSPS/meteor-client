...
public class WorldMapIcon_1 extends AbstractWorldMapIcon {
	...
	static int method1400(int var0, int var1) {
	...
	static void method1406(int var0) {
		...
		if (var1.isCachedModelIdSet()) {
			...
			class136 var4 = HealthBar.method556(var3);
			int var2;
			if (var4 == null) {
				var2 = 2;
			} else {
				var2 = var4.method720() ? 0 : 1;
			}

			if (var2 == 2) {
				Client.field606.add(var1.SequenceDefinition_cachedModelId);
			}
