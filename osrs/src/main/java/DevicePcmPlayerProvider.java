...
public class DevicePcmPlayerProvider implements class51 {
	...
	static final void loadTerrain(Buffer var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		int var7;
		if (class169.method871(var1, var2, var3)) {
			...
			while (true) {
				...
				if (var7 == 0) {
					if (var1 == 0) {
						Tiles.Tiles_heights[0][var2][var3] = -class107.method605(var4 + 932731, var5 + 556238) * 8;
					} else {
				...
				if (var7 <= 49) {
					...
					Tiles.field831[var1][var2][var3] = (byte)(var7 - 2 + var6 & 3);
				} else if (var7 <= 81) {
