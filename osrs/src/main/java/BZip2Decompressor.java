...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field4087 = 0;
	...
	static void method2563(BZip2State var0) {
		...
		int var13 = var0.field4087;
		var0.field4087 += var10 - var10;
		if (var0.field4087 < var13) {
		}
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		int[] var24 = null;
		int[] var25 = null;
		var0.blockSize100k = -123131011;
		if (Clock.BZip2Decompressor_block == null) {
			Clock.BZip2Decompressor_block = new int[var0.blockSize100k * 1370628896];
		}
				...
				while (true) {
					...
					while (var46 != var42) {
						if (var46 != 0 && var46 != 1) {
							...
							Clock.BZip2Decompressor_block[var47] = var0.seqToUnseq[var1 & 255] & 255;
							++var47;
							if (var45 == 0) {
								++var43;
								var45 = 50;
							...
							for (var10000[var1 & 255] += var48; var48 > 0; --var48) {
								Clock.BZip2Decompressor_block[var47] = var1 & 255;
								++var47;
							}
						}
					}
					...
					var0.field4092 = Clock.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field4092 = Clock.BZip2Decompressor_block[var0.field4092];
					var0.su_ch2 = (byte)(var0.field4092 & 255);
					var0.field4092 >>= 8;
					++var0.nblocks_used;
					var0.field4095 = var47;
					method2563(var0);
					if (var0.field4095 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
