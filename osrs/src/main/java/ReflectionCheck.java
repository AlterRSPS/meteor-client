...
public class ReflectionCheck extends Node {
	...
	static void method164() {
		if (Login.clearLoginScreen) {
			...
			class19.field59 = null;
			class237.field2150.method509();
	...
	static final void method165(int var0, int var1, boolean var2) {
		if (!var2 || var0 != class208.timeOfPreviousKeyPress || ObjTypeCustomisation.field1471 != var1) {
			class208.timeOfPreviousKeyPress = var0;
			ObjTypeCustomisation.field1471 = var1;
			UserComparator8.updateGameState(25);
			AABB.drawLoadingMessage("Loading - please wait.", true);
			int var3 = class213.baseX;
			int var4 = class101.baseY;
			class213.baseX = (var0 - 6) * 8;
			class101.baseY = (var1 - 6) * 8;
			int var5 = class213.baseX - var3;
			...
			for (PendingSpawn var19 = (PendingSpawn)Client.pendingSpawns.last(); var19 != null; var19 = (PendingSpawn)Client.pendingSpawns.previous()) {
				var19.field_3 -= var5;
				var19.field_4 -= var6;
				if (var19.field_3 < 0 || var19.field_4 < 0 || var19.field_3 >= 104 || var19.field_4 >= 104) {
					var19.remove();
				}
			}
