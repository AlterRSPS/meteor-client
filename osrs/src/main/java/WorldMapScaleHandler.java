...
public class WorldMapScaleHandler {
	...
	void method1564(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		if (var7 != 0 && this.pixelsPerTile != 0 && this.tileTemplates != null) {
			var8 = this.method1566(var8, var7);
			var7 = this.method1568(var7);
	...
	int method1566(int var1, int var2) {
		if (var2 == 9) {
			var1 = var1 + 1 & 3;
		}
	...
	static final int method1565(LoginType var0) {
		if (var0 == null) {
			return 12;
		} else {
			switch(var0.field4013) {
			case 6:
				return 20;
			default:
				return 12;
	...
	public static SpritePixels[] method1567(AbstractArchive var0, int var1, int var2) {
		...
		return !var3 ? null : WorldMapEvent.method1580();
	}
	...
	static int method1574(AbstractArchive var0, AbstractArchive var1) {
		int var2 = 0;
	...
	public static final void method1571(int var0, boolean var1, int var2) {
		if (var0 >= 8000 && var0 <= 48000) {
			PcmPlayer.field180 = var0;
			class347.PcmPlayer_stereo = var1;
			class260.field2373 = var2;
		} else {
