...
public class UserComparator10 extends AbstractUserComparator {
	...
	static String method665() {
		String var0;
		if (class10.clientPreferences.getIsUsernameHidden()) {
			String var2 = Login.Login_username;
			String var1 = GrandExchangeOfferAgeComparator.method1931('*', var2.length());
			var0 = var1;
		} else {
	...
	static final void drawObject(int var0, int var1, int var2, int var3, int var4) {
		...
		if (0L != var5) {
			...
			if (var24.mapSceneId != -1) {
				IndexedSprite var18 = class47.mapSceneSprites[var24.mapSceneId];
				if (var18 != null) {
				...
				int[] var20 = class33.sceneMinimapSprite.pixels;
	...
	static final void clickWidget(Widget var0, int var1, int var2) {
		if (Client.clickedWidget == null && !Client.isMenuOpen) {
			if (var0 != null) {
				Widget var5 = var0;
				int var6 = Interpreter.method413(StudioGame.getWidgetFlags(var0));
				Widget var4;
				int var7;
				if (var6 == 0) {
					var4 = null;
				...
				if (var8 != null) {
					...
					var5 = var0;
					var6 = Interpreter.method413(StudioGame.getWidgetFlags(var0));
					if (var6 == 0) {
						var4 = null;
					} else {
						var7 = 0;
					...
					int var9 = class132.method710();
					if (var9 != -1) {
						class195.method988(var9);
					}
