...
public final class WorldMapSprite {
	...
	static void getLoginError(int var0) {
		...
		if (var0 == -3) {
			...
			class390.method2013(3);
			Login.field750 = 1;
		} else if (var0 == 4) {
			class390.method2013(14);
			Login.field751 = 0;
		} else if (var0 == 5) {
			Login.field750 = 2;
		...
		UserComparator8.updateGameState(10);
		boolean var2 = var1 != class135.method717();
		if (!var2 && Client.field646.method2572()) {
			class390.method2013(9);
		}
